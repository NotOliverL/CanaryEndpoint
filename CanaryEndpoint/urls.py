...
from api.views import EndpointViewSet, APICallViewSet, login_view, logout_view, verify_session_view
...
urlpatterns = [
    ...
    re_path(r'^(?!static|api|r|admin|media).*$', TemplateView.as_view(template_name='index.html'), name='index'),
]
